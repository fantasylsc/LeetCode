...
|[Quick Sort](./Classification/Quick_Sort.py)| Θ(nlogn) | Ω(nlogn) | O(n^2) | O(logn) Recursion call|[Video](https://www.youtube.com/watch?v=PgBzjlCcFvc), [QuickSelect](https://www.geeksforgeeks.org/quickselect-algorithm/)|
